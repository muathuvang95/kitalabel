            ...
            $timeout(function(){
                ...
                if($scope.options.combination.enabled == 'on') {
                    ...
                    if( _area_name!= '' && size_name != '' && material_name != '' ) {
                        var _quantity = parseInt( $scope.options.combination.options[_area_name][size_name][material_name].qty );
                        if( _quantity < 1 || isNaN(_quantity) || typeof _quantity == 'undefined' ) {
                            _quantity = 1;
                        }
                        $timeout(function(){
                            jQuery('input[name="quantity"]').val(_quantity);
