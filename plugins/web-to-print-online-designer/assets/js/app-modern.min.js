...
/*                 if( angular.isDefined( data.area ) ){
    ...
    $scope.saveData = function(type){
        ...
        function _saveData(){
            ...
            if(angular.isDefined(nbd_window.nbOption) && angular.isDefined(nbd_window.nbOption.printingOptions)) {
                dataObj.printing_options = new Blob([nbd_window.nbOption.printingOptions], {type: "application/json"}); // custom kitalabel
            }
            _.each($scope.stages, function(stage, index){
                // custom design name
