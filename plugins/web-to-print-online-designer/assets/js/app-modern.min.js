...
/*                 if( angular.isDefined( data.area ) ){
    ...
    $scope.saveData = function(type){
        ...
        function _saveData(){
            ...
            dataObj.printings = new Blob([JSON.stringify($scope.resource.jsonDesign)], {type: "application/json"});
            // if(type == 'saveforlater') {
            //     if($scope.printingOptions) {
            //         dataObj.printings = new Blob([JSON.stringify($scope.printingOptions)], {type: "application/json"});
            //     }
            // }
            _.each($scope.stages, function(stage, index){
                // custom design name
