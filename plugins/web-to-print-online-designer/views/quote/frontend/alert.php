    ...
    <div class="main-popup">
        ...
        <div class="nbd-alert-body">
            <div class="nbd-alert-wrapper">
                <p><?php _e( 'Your request for a quote has been sent to Printing Specialist. Please wait for the proposal review via email!', 'web-to-print-online-designer' ); ?></p>
...
<!--                    <a class="button" href="<?php echo www.staging.kitalabel.com;?>"><?php _e('Return to Home', 'web-to-print-online-designer'); ?></a> -->
