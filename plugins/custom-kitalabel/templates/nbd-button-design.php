    ...
    <div class="nbd-m-custom-design-wrap" id="nbd-m-custom-design-wrap">
        <div id="nbd_processing">
            <div class="atom-loading">
                <img class="kita-loading" src="<?php echo NBDESIGNER_ASSETS_URL.'/images/loading_new.gif' ?>">
        ...
        <?php 
            ...
            if( $_enable_upload ){
                if( $upload_style == 'a' && isset( $option['advanced_upload'] ) && $option['advanced_upload'] == 1 ){
                    ...
                    include( NBDESIGNER_PLUGIN_DIR.'templates/single-product/simple-upload.php' );
                }
            }
        ?>
    </div> 
