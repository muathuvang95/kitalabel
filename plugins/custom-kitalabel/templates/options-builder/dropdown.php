...
<div class="nbd-option-field nbd-field-dropdown-wrap <?php echo $class; ?>" data-id="<?php echo $field['id']; ?>" style="width: 50%; display: inline-block; margin: 0" ng-if="nbd_fields['<?php echo $field['id']; ?>'].enable">
