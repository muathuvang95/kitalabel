...
<div class="nbd-option-field" id="nbo-quantity-option-wrap" style="width: 100%; display: inline-block; margin: 0">
    ...
    <div class="nbd-field-content">
        ...
        <?php elseif( $options['quantity_type'] == 'd' ): ?>
            <div class="nbd-selected" style="display: flex;">
                <select name="nbo-quantity" convert-to-number class="nbo-dropdown" ng-change="f_change_quantity()" ng-model="_quantity">
                    <?php 
                ...
                <div ng-if="custom_qty.enable" style="width: 100%; margin-left: 10px;">
                    <input ng-model="custom_qty.value" type="number" min="<?php echo !empty($options['quantity_breaks'][0]) ? $options['quantity_breaks'][0] : 1; ?>" ng-change="_change_quantity()" />
                </div>
            </div>
