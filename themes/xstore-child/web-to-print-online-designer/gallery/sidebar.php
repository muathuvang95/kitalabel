...
<?php if( nbdesigner_get_option('nbdesigner_item_sidebar_cat') == 1 ) { ?>
...
<?php if( nbdesigner_get_option('nbdesigner_item_sidebar_designer') == 1 ) { ?>
...
<?php if( nbdesigner_get_option('nbdesigner_item_sidebar_products') == 1 ) { ?>
<div class="nbd-designers nbd-sidebar-con">
...
<?php if( nbdesigner_get_option('nbdesigner_item_sidebar_wishlist') == 1 ) { ?>
<div class="nbd-designers nbd-sidebar-con">
