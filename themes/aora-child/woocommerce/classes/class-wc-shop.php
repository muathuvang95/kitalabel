...
if ( ! class_exists( 'Aora_Shop_WooCommerce' ) ) :
	...
	class Aora_Shop_WooCommerce  {
		...
		public function __construct() {
			...
			add_action( 'nb_custom_before_shop_loop', array( $this, 'shop_filter_before') , 3 );
			add_action( 'nb_custom_before_shop_loop', array( $this, 'content_shop_filter_before') , 15 );
			add_action( 'nb_custom_before_shop_loop', array( $this, 'content_shop_filter_after') , 70 );
			add_action( 'nb_custom_before_shop_loop', array( $this, 'shop_filter_after') , 70 );

			
			/*Filter Sidebar*/
			add_action( 'nb_custom_before_shop_loop', array( $this, 'button_filter_sidebar_html') , 20 );
