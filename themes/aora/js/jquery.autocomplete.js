...
class AutoComplete {
  ...
  _callAjaxSearch() {
    var _this = this,
        url = aora_settings.ajaxurl + '?action=aora_autocomplete_search&security=' + aora_settings.search_nonce,
        form = $('form.searchform.aora-ajax-search'),
      ...
      autosearch.devbridgeAutocomplete({
        ...
        beforeRender: function (container, suggestion) {
          ...
          if (suggestion[0].view_all) {
            $(container).append('<div class="view-all-products"><span>' + aora_settings.show_all_text + '</span></div>');
          }
        },
