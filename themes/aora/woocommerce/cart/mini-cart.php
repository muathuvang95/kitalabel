		...
		<div class="mcart-border">
			...
			<?php else: ?>
				<ul class="cart_empty <?php echo esc_attr($args['list_class']); ?>">
					...
					<li class="total"><a class="button wc-continue" href="<?php echo esc_url( get_home_url() ); ?>"><?php esc_html_e( 'Back to Home', 'aora' ) ?><i class="tb-icon tb-icon-angle-right"></i></a></li>
				</ul>
			<?php endif; ?>
