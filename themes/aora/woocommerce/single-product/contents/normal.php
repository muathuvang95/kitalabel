...
$social_share 			= 	( aora_tbay_get_config('enable_code_share',false)  && aora_tbay_get_config('enable_product_social_share', false) );
...
<div class="single-main-content">
	...
	<div class="row">
		<div class="image-mains col-lg-8 <?php echo esc_attr( $class_thumbnail ); ?>">
			<?php
				/**
