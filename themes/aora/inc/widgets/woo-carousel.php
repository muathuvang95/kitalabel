...
class Tbay_Widget_Woo_Carousel extends Tbay_Widget {
    public function __construct() {
        parent::__construct(
            'aora_woo_carousel',
            esc_html__('Aora woocommerce Carousel', 'aora'),
            array( 'description' => esc_html__( 'Show list product', 'aora' ), )
        );
    ...
    public function form( $instance ) {
        ...
        <p>
            ...
            ?>
            <label for="<?php echo esc_attr($this->get_field_id( 'categories' )); ?>"><?php esc_html_e( 'Please select category to show:', 'aora' ); ?></label>
            ...
            <?php else: ?>
                ...
                <?php esc_html_e('No woocommerce category found ', 'aora'); ?>
        ...
        <p>
            <label for="<?php echo esc_attr($this->get_field_id( 'numbers' )); ?>"><?php esc_html_e( 'Number of products to show:', 'aora' ); ?></label>
        ...
        <p>
            <label for="<?php echo esc_attr($this->get_field_id( 'types' )); ?>"><?php esc_html_e( 'Type Products:', 'aora' ); ?></label>
            ...
            <?php else: ?>
                ...
                <?php esc_html_e('No choose type product found ','aora'); ?>
        ...
        <p>
            <label for="<?php echo esc_attr($this->get_field_id( 'columns' )); ?>"><?php esc_html_e( 'Columns:', 'aora' ); ?></label>
            ...
            <?php else: ?>
                ...
                <?php esc_html_e('No choose columns product found ', 'aora'); ?>
        ...
        <p>
            <label for="<?php echo esc_attr($this->get_field_id( 'columns_destsmall' )); ?>"><?php esc_html_e( 'Columns screen desktop small:', 'aora' ); ?></label>
            ...
            <?php else: ?>
                ...
                <?php esc_html_e('No choose columns desktop small product found ', 'aora'); ?>
        ...
        <p>
            <label for="<?php echo esc_attr($this->get_field_id( 'columns_tablet' )); ?>"><?php esc_html_e( 'Columns screen tablet:', 'aora' ); ?></label>
            ...
            <?php else: ?>
                ...
                <?php esc_html_e('No choose columns table product found ','aora'); ?>
        ...
        <p>
            <label for="<?php echo esc_attr($this->get_field_id( 'columns_mobile' )); ?>"><?php esc_html_e( 'Columns screen mobile:', 'aora' ); ?></label>
        ...
        <p>
            <label for="<?php echo esc_attr($this->get_field_id( 'rows' )); ?>"><?php esc_html_e( 'Rows:', 'aora' ); ?></label>
            ...
            <?php else: ?>
                ...
                <?php esc_html_e('No choose rows product found ','aora'); ?>
        ...
        <p><input id="<?php echo esc_attr($this->get_field_id('navigations')); ?>" name="<?php echo esc_attr($this->get_field_name('navigations')); ?>" type="checkbox" value="1" <?php checked( $navigations ); ?> />
            <label for="<?php echo esc_attr($this->get_field_id('navigations') ); ?>">
                <?php esc_html_e('Show navigations','aora'); ?>
            </label>
        ...
        <p><input id="<?php echo esc_attr($this->get_field_id('paginations')); ?>" name="<?php echo esc_attr($this->get_field_name('paginations')); ?>" type="checkbox" value="1" <?php checked( $paginations ); ?> />
            <label for="<?php echo esc_attr($this->get_field_id('paginations') ); ?>">
                <?php esc_html_e('Show paginations','aora'); ?>
            </label>
        ...
        <p><input id="<?php echo esc_attr($this->get_field_id('disable_mobile')); ?>" name="<?php echo esc_attr($this->get_field_name('disable_mobile')); ?>" type="checkbox" value="1" <?php checked( $disable_mobile ); ?> />
            <label for="<?php echo esc_attr($this->get_field_id('disable_mobile') ); ?>">
                <?php esc_html_e('Disable mobile','aora'); ?>
            </label>
