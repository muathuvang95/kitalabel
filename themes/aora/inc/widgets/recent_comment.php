...
class Tbay_Widget_Recent_Comment extends Tbay_Widget {
    public function __construct() {
        parent::__construct(
            'aora_recent_comment',
            esc_html__('Aora Recent Comments', 'aora'),
            array( 'description' => esc_html__( 'Show list of recent comments', 'aora' ), )
        );
    ...
    public function form( $instance ) {
        if ( isset( $instance[ 'title' ] ) ) {
            ...
            $title = esc_html__( 'Latest Post', 'aora' );
        }
        ...
        <p>
            <label for="<?php echo esc_attr($this->get_field_id( 'number_comment' )); ?>"><?php esc_html_e( 'Num Comments:', 'aora' ); ?></label>
