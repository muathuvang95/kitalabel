...
if ( !class_exists("Aora_Tbay_mmenu_menu") ) {
    class Aora_Tbay_mmenu_menu extends Walker_Nav_Menu {
        ...
        public function generateSubMegaMenu( $item, $tbay_mega_profile ) {
            ...
            if ( $tbay_mega_profile ) {
                ...
                if ( $posts && isset($posts[0]) ) {
                    ...
                    if( defined('TBAY_ELEMENTOR_ACTIVED') && aora_elementor_is_activated() && in_array( 'tbay_megamenu', get_option( 'elementor_cpt_support' ) ) ) {
