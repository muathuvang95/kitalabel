...
if ( ! defined( 'ABSPATH' ) || function_exists('Aora_Elementor_Custom_Image_List_Categories') ) {
 ...
 * @since 1.0.0
 */
class Aora_Elementor_Custom_Image_List_Categories extends  Aora_Elementor_Carousel_Base{
    /**
     * Get widget name.
     *
    ...
    public function get_title() {
        return esc_html__( 'Aora Custom Image List Categories', 'aora' );
    }
    ...
    protected function register_controls() {
        ...
        $this->add_control(
            'list_category',
            [
                'label' => esc_html__( 'List Categories Items', 'aora' ),
...
$widgets_manager->register_widget_type(new Aora_Elementor_Custom_Image_List_Categories());
