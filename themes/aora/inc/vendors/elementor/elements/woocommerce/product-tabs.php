...
if ( ! defined( 'ABSPATH' ) || function_exists('Aora_Elementor_Product_Tabs') ) {
 ...
 * @since 1.0.0
 */
class Aora_Elementor_Product_Tabs extends  Aora_Elementor_Carousel_Base{
    /**
     * Get widget name.
     *
    ...
    public function get_title() {
        return esc_html__( 'Aora Product Tabs', 'aora' );
    }
    ...
    protected function register_controls() {
        ...
        $this->start_controls_section(
            'section_general',
            [
                'label' => esc_html__( 'Product Tabs', 'aora' ),
            ]
        );
        $this->add_control(
            'limit',
            [
                'label' => esc_html__('Number of products ( -1 = all )', 'aora'),
    ...
    public function register_controls_product_tabs() {
        ...
        $repeater->add_control(
            'product_tabs',
            [
                'label' => esc_html__('Show Tabs', 'aora'),
                'type' => Controls_Manager::SELECT,
        ...
        $this->add_control(
            'list_product_tabs',
            [
                'label' => esc_html__('Tab Item','aora'),
...
$widgets_manager->register_widget_type(new Aora_Elementor_Product_Tabs());
