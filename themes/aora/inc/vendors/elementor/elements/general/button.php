...
if ( ! defined( 'ABSPATH' ) || function_exists('Aora_Elementor_Button') ) {
 ...
 * @since 1.0.0
 */
class Aora_Elementor_Button extends  Aora_Elementor_Widget_Base{
    /**
     * Get widget name.
     *
    ...
    public function get_title() {
        return esc_html__( 'Aora Button', 'aora' );
    }
    ...
    protected function register_controls() {
        ...
        $this->add_control(
            'link_button',
            [
                'label' => esc_html__( 'Link Button', 'aora' ),
        ...
        $this->add_control(
            'add_icon',
            [
                'label' => esc_html__( 'Add Icon', 'aora' ),
...
$widgets_manager->register_widget_type(new Aora_Elementor_Button());
