...
if ( ! defined( 'ABSPATH' ) || function_exists('Aora_Elementor_Posts_Grid') ) {
...
class Aora_Elementor_Posts_Grid extends Aora_Elementor_Carousel_Base {
    ...
    public function get_title() {
        return esc_html__( 'Aora Posts Grid', 'aora' );
    }
    ...
    protected function register_controls() {
        ...
        $this->add_control(
            'limit',
            [
                'label' => esc_html__('Number of posts', 'aora'),
                'type' => Controls_Manager::NUMBER,
                'description' => esc_html__( 'Number of posts to show ( -1 = all )', 'aora' ),
                'default' => 6,
                'min'  => -1
            ]
        );
        ...
        $this->add_control(
            ...
            [
                ...
                'default' => 'post_date',
                'options' => [
                    'post_date'  => esc_html__('Date', 'aora'),
                    'post_title' => esc_html__('Title', 'aora'),
    ...
    protected function register_title_controls() {
        ...
        $this->add_control(
            ...
            [
                ...
                'label_on' => esc_html__( 'Show', 'aora' ),
                'label_off' => esc_html__( 'Hide', 'aora' ),
                'default' => 'yes',
    ...
    protected function register_excerpt_controls() {
        ...
        $this->add_control(
            'excerpt_length',
            [
                'label' => esc_html__( 'Excerpt Length', 'aora' ),
                'type' => Controls_Manager::NUMBER,
    ...
    protected function register_read_more_controls() {
        $this->add_control(
            'advanced_read_more',
            [
                'label' => esc_html__('Read More', 'aora'),
                'type' => Controls_Manager::HEADING,
                'separator' => 'before',
            ]
        );
        ...
        $this->add_control(
            'read_more_text',
            [
                'label' => esc_html__( 'Read More Text', 'aora' ),
    ...
    protected function register_meta_controls() {
        ...
        $this->add_control( 
            'show_comments',
            [
                'label' => esc_html__( 'Comments', 'aora' ),
                'type' => Controls_Manager::SWITCHER,
                'label_on' => esc_html__( 'Show', 'aora' ),
                'label_off' => esc_html__( 'Hide', 'aora' ),
                'default' => 'yes',
        ...
        $this->add_control( 
            'show_comments_text',
            [
                'label' => esc_html__( 'Comments Text', 'aora' ),
                'type' => Controls_Manager::SWITCHER,
                'label_on' => esc_html__( 'Show', 'aora' ),
                'label_off' => esc_html__( 'Hide', 'aora' ),
                'default' => 'no',
    ...
    private function get_template_post_type() {
        $folderes = glob(AORA_PAGE_TEMPLATES. '/posts/item-*');
...
$widgets_manager->register_widget_type(new Aora_Elementor_Posts_Grid());