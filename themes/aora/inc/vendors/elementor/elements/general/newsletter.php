...
if ( ! defined( 'ABSPATH' ) || function_exists('Aora_Elementor_Newsletter') ) {
...
class Aora_Elementor_Newsletter extends Aora_Elementor_Widget_Base {
    /**
     * Get widget name.
     *
    ...
    public function get_title() {
        return esc_html__( 'Aora newsletter', 'aora' );
    }
    ...
    protected function register_controls() {
        ...
        $this->add_control(
            'form_style',
            [
                'label'        => esc_html__( 'Form Style Block', 'aora' ),
        ...
        $this->add_responsive_control(
            'width_input',
            [
                'label'      => esc_html__( 'Input Width', 'aora' ),
        ...
        $this->add_control(
            'text_hide',
            [
                'label'        => esc_html__( 'Hide Text', 'aora' ),
                'type'         => Controls_Manager::SWITCHER,
                'label_off'    => esc_html__( 'Off', 'aora' ),
                'label_on'     => esc_html__( 'On', 'aora' ),
                'default'      => '',
        ...
        $this->add_control(
            'icon_hide',
            [
                'label'        => esc_html__( 'Hide Icon', 'aora' ),
                'type'         => Controls_Manager::SWITCHER,
                'label_off'    => esc_html__( 'Off', 'aora' ),
                'label_on'     => esc_html__( 'On', 'aora' ),
                'default'      => '',
        ...
        $this->add_responsive_control(
            'icon_margin',
            [
                'label'      => esc_html__( 'Margin Icon', 'aora' ),
        ...
        $this->add_responsive_control(
            'width_button',
            [
                'label'      => esc_html__( 'Buton width', 'aora' ),
                'type'       => Controls_Manager::SLIDER,
                'range'      => [
                    'px' => [
                        'min' => 0,
        ...
        $this->add_control(
            'placeholder_color',
            [
                'label'     => esc_html__( 'Placeholder Color', 'aora' ),
                'type'      => Controls_Manager::COLOR,
                'scheme'    => [
                    'type'  => Schemes\Color::get_type(),
                    'value' => Schemes\Color::COLOR_3,
        ...
        $this->add_control(
            'button_border_hover',
            [
                'label'     => esc_html__( 'Border Color', 'aora' ),
                'type'      => Controls_Manager::COLOR,
                'selectors' => [
        ...
        $this->add_control(
            'button_color_focus',
            [
                'label'     => esc_html__( 'Button Color', 'aora' ),
                'type'      => Controls_Manager::COLOR,
                'selectors' => [
...
$widgets_manager->register_widget_type(new Aora_Elementor_Newsletter());