...
if ( ! defined( 'ABSPATH' ) || function_exists('Aora_Elementor_List_Menu') ) {
...
class Aora_Elementor_List_Menu extends Aora_Elementor_Widget_Base {
    ...
    public function get_title() {
        return esc_html__('Aora List Menu', 'aora');
    }
    ...
    protected function register_controls() {
        ...
        $this->add_control(
            'list_menu_separator',
            [
                'label' => esc_html__('Separator Between', 'aora'),
...
$widgets_manager->register_widget_type(new Aora_Elementor_List_Menu());
