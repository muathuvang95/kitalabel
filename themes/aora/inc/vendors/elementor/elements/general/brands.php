...
if ( ! defined( 'ABSPATH' ) || function_exists('Aora_Elementor_Brands') ) {
 ...
 * @since 1.0.0
 */
class Aora_Elementor_Brands extends  Aora_Elementor_Carousel_Base{
    /**
     * Get widget name.
     *
    ...
    public function get_title() {
        return esc_html__( 'Aora Brands', 'aora' );
    }
    ...
    protected function register_controls() {
        ...
        $this->add_control(
            'brands',
            [
                'label' => esc_html__( 'Brand Items', 'aora' ),
...
$widgets_manager->register_widget_type(new Aora_Elementor_Brands());
