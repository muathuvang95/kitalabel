...
if ( ! defined( 'ABSPATH' ) || function_exists('Aora_Elementor_Wishlist') ) {
...
class Aora_Elementor_Wishlist extends Aora_Elementor_Widget_Base {
    ...
    public function get_title() {
        return esc_html__('Aora Wishlist', 'aora');
    }
    ...
    protected function register_controls() {
        ...
        $this->start_controls_section(
            'section_layout',
            [
                'label' => esc_html__('Wishlist', 'aora'),
            ]
        );
        ...
        $this->add_control(
            'show_title_wishlist',
            [
                'label'              => esc_html__('Display Title', 'aora'),
        ...
        $this->add_control(
            ...
            [
                ...
                'default' => esc_html__('My Wishlist','aora'),
                'condition' => [
        ...
        $this->add_control(
            'show_total_wishlist',
            [
                'label'              => esc_html__('Show Total', 'aora'),
                'type'               => Controls_Manager::SWITCHER,
                'default'            => 'yes',
            ]
        );
    ...
    private function register_section_style_total() {
        ...
        $this->add_control(
            'position_left',
            [
                'label'     => esc_html__('Position Left', 'aora'),
                'type' => Controls_Manager::SLIDER,
				'range' => [
					'px' => [
						'min' => 0,
...
$widgets_manager->register_widget_type(new Aora_Elementor_Wishlist());
