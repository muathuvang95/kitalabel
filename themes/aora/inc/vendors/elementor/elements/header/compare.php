...
if ( ! defined( 'ABSPATH' ) || function_exists('Aora_Elementor_Compare') ) {
...
class Aora_Elementor_Compare extends Aora_Elementor_Widget_Base {
    public function get_name() {
        return 'tbay-compare';
    }

    public function get_title() {
        return esc_html__('Aora Compare', 'aora');
    }
    ...
    protected function register_controls() {
        ...
        $this->add_control(
            ...
            [
                ...
                'default' => esc_html__('My Compare', 'aora'),
                'condition' => [
...
$widgets_manager->register_widget_type(new Aora_Elementor_Compare());
