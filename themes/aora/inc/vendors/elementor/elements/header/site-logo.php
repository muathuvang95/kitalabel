...
if ( ! defined( 'ABSPATH' ) || function_exists('Aora_Elementor_Widget_Image') ) {
    exit; // Exit if accessed directly.
}

use Elementor\Controls_Manager;

class Aora_Element_Site_Logo extends Aora_Elementor_Widget_Image {

    public function get_name() {
        // `theme` prefix is to avoid conflicts with a dynamic-tag with same name.
        return 'aora-site-logo';
    }

    public function get_title() {
        return esc_html__( 'Aora Site Logo', 'aora' );
    }
        ...
        $this->update_control(
            ...
            [
                ...
                'options' => [ 
                    ...
                    'home' => esc_html__( 'Home Page', 'aora' ),
                    'custom' => esc_html__( 'Custom URL', 'aora' ),
                ],
            ]
        ); 
    ...
    public static function get_logo_default_image_src() {
        $logo_image = AORA_IMAGES . '/logo.png';
...
$widgets_manager->register_widget_type(new Aora_Element_Site_Logo());