...
$class_main = apply_filters('aora_tbay_post_content_class', 'container');
...
<section id="main-container" class="main-content <?php echo esc_attr($class_main); ?>">
	...
	<?php do_action( 'aora_post_template_main_container_before' ); ?>
	...
	<div class="row <?php echo esc_attr($class_row); ?>">
		...
		<div id="main-content" class="container <?php echo esc_attr($main_class); ?>">
			<div id="main" class="site-main layout-blog">
				...
				<?php do_action( 'aora_post_template_main_content_before' ); ?>
				...
				<?php
					...
					aora_tbay_paging_nav();
				?>
				<?php do_action( 'aora_post_template_main_content_after' ); ?>
	...
	<?php do_action( 'aora_post_template_main_container_after' ); ?>
</section>
<?php get_footer(); ?>
