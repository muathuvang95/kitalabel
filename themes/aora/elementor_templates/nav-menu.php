...
if( $show_content_menu === 'yes' && aora_tbay_is_home_page() ) {
...
<div <?php echo trim($this->get_render_attribute_string('wrapper')); ?>>
	...
	<?php if ( $type_menu !== 'none' ) echo '<div '. trim($this->get_render_attribute_string('content-class')) .' >'; ?>
	...
	<?php if ( $type_menu !== 'none' ) echo '</div>'; ?>
